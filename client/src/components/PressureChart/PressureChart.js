...
const PressureChart = ({ config, data }) => (
    <div className="chart-container">
        ...
        <AreaChart width={450} height={350} data={takeLast(config.maxShowedValues, data)}
            ...
            <Area name='BME interní' type='monotone' dataKey='pressureCanSat' stroke='#007AC1' fill='#67DAFF' />
            <Area name='BME externí' type='monotone' dataKey='pressureExternal' stroke='#001064' fill='#5F5FC4' />
        </AreaChart>
    </div>
);
